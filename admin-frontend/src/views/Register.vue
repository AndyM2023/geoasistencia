...
export default {
  ...
  setup() {
    ...
    const success = ref('')
          ...
          // Opciones para el campo cargo (valores deben coincidir con el backend)
      const positionOptions = [
        { text: 'Administrador de Personal', value: 'administrador_personal' },
        { text: 'Asistente de RR. HH.', value: 'asistente_rrhh' },
        { text: 'Técnico de RR. HH.', value: 'tecnico_rrhh' },
        { text: 'Gerente', value: 'gerente' },
        { text: 'Recursos Humanos', value: 'recursos_humanos' },
        { text: 'Contador', value: 'contador' },
        { text: 'Analista', value: 'analista' },
        { text: 'Administrativo', value: 'administrativo' },
        { text: 'Otro (Acceso Administrativo)', value: 'otro' }
      ]
